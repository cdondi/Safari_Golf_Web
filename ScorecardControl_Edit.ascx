<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ScorecardControl_Edit.ascx.vb" Inherits="ScorecardControl" %>
...
<%@ Register TagPrefix="Club" TagName="LoginBanner" Src="LoginBanner.ascx" %>                                                 
    ...
    <asp:UpdatePanel ID="UpdatePanel11" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
             ...
             <asp:Label ID="lblpairid" visible="false" runat="server"></asp:Label>
            ...
            <table cellpadding="0" cellspacing="0"   border="1" style="width: 700px">  
                    ...
                    <tr>                    
                        ...
                        <td  class="auto-style1"><asp:Label ID="lblUserNameScore1" runat="server"></asp:Label></td>                    
                       
                                                                        
                  <td ><asp:DropDownList ID="txtScore1_1" runat="server"  Width="36">                         
                ...
                <td ><asp:DropDownList ID="txtScore1_2" runat="server"  Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                 ...
                 <td ><asp:DropDownList ID="txtScore1_3" runat="server"  Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                 ...
                 <td ><asp:DropDownList ID="txtScore1_4" runat="server"  Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                 ...
                 <td ><asp:DropDownList ID="txtScore1_5" runat="server"   Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                 ...
                 <td ><asp:DropDownList ID="txtScore1_6" runat="server" Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                 ...
                 <td ><asp:DropDownList ID="txtScore1_7" runat="server"   Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                 ...
                 <td ><asp:DropDownList ID="txtScore1_8" runat="server" Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                ...
                <td ><asp:DropDownList ID="txtScore1_9" runat="server"   Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
                  ...
                  <td ><asp:DropDownList ID="txtScore1_10" runat="server"  Width="36">                         
                    <asp:ListItem Value="0" Text="0"></asp:ListItem> 
                    <asp:ListItem Value="1" Text="1"></asp:ListItem> 
                    <asp:ListItem Value="2" Text="2"></asp:ListItem> 
                    <asp:ListItem Value="3" Text="3"></asp:ListItem> 
          ...
          <asp:Button ID="Save1" OnClientClick="Save1_Click"   runat="server" height="40px" Text="Save Changes" /> &nbsp;&nbsp;<asp:Button ID="Close1" Visible="false" runat="server" height="40px" Text="Close ScoreCard" />&nbsp;&nbsp;<asp:Button ID="CreateScoreCard" runat="server" height="40px" Text="Create My ScoreCard" />
