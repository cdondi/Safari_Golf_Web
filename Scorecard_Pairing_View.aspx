<%@ Page Title="" Language="VB" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Scorecard_Pairing_View.aspx.vb" Inherits="Events_Calendar"   Culture="auto" UICulture="auto"   %>
				...
				<!-- begin news item -->
         		...
         		<asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" >
					<ItemTemplate>
						<div>  
							<h3>
								<a href='<%# "Scorecard_Pairing_View.aspx?LocationID=" + Convert.ToString(Eval("LocationID")) + "&DateID=" + Convert.ToString(Eval("starttime"))%>'/>
