...
Partial Public Class Events_Calendar
    ...
    {"ScorecardId", "GhinID", "LocationID", "PairingID", "Date", "memberid", "playername", "Score1", "Score2", "Score3", "Score4", "Score5", "Score6", "Score7", "Score8", "Score9", "Score10", "ScoreTotalout", "Score11", "Score12", "Score13", "Score14", "Score15", "Score16", "Score17", "Score18", "ScoreTotalin", "TournamentHandicap", "GhinHandicap", "NetScore"})
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            SetupShowHideColumns(Me.grdViewScorecard1, Me.GridView1ShowHideColumns)
        End If
    End Sub
    ...
    Protected Sub grdViewScorecard1_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        ...
        '    grdViewScorecard1.Columns(10).Visible = False
        '    grdViewScorecard1.Columns(20).Visible = False
        '    grdViewScorecard1.Columns(21).Visible = False
        '    grdViewScorecard1.Columns(22).Visible = False
        ...
        '    grdViewScorecard1.Columns(10).Visible = True
        '    grdViewScorecard1.Columns(20).Visible = True
        '    grdViewScorecard1.Columns(21).Visible = True
        '    grdViewScorecard1.Columns(22).Visible = True
    ...
    Private Sub grdViewScorecard1BindData()
        ...
        Me.grdViewScorecard1.DataSource = _GetScoreCardData(xssql)
        Me.grdViewScorecard1.DataBind()
