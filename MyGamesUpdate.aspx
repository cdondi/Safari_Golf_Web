<%@ Page Title="" Language="VB" MasterPageFile="~/Default.master"  AutoEventWireup="true"  CodeFile="MyGamesUpdate.aspx.vb"  Inherits="Events_Calendar" %>
		   ...
		   <table>
			...
			<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ClubSiteDB %>"
				...
				<asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" >
					<ItemTemplate>
						<div> 
								<a href='<%# "MyGamesUpdate.aspx?Dateid=" + Convert.ToString(Eval("Dateid")) & "&locationid=" + Convert.ToString(Eval("locationid"))%>'>
