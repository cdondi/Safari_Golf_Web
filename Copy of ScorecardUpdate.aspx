<%@ Page Title="" Language="VB" MasterPageFile="~/Default.master"  AutoEventWireup="true"  CodeFile="Copy of ScorecardUpdate.aspx.vb"  Inherits="Events_Calendar" %>
...
onrowupdating="grdViewScorecard1UpdateScore"  onrowcancelingedit="grdViewScorecard1CancelEdit" >
    ...
    <Columns>
        ...
        <asp:BoundField DataField="playername" HeaderText="Hole" ItemStyle-HorizontalAlign="Left" />  
    ...
    <AlternatingRowStyle BackColor="White" />
     ...
     <table border="0" style="width: 410px"  cellpadding="0" cellspacing="0">  
        <tr> 
         <td>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnScoreCard" runat="server"   Text="Refresh"  height="20px" />&nbsp;&nbsp;<asp:Button ID="CreateScoreCard" runat="server" height="20px" Text="Create My ScoreCard" />
