...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	<div id="body">
    	...
    	<h1>Safari Golf Club of Texas</h1>
	<p>
		Welcome to your new <strong>Safari Golf Club of Texas</strong> site. The key features are:</p>
	<ul>
		<li><strong>News.</strong> Announce news to Safari Golf Club.</li>
		...
		<li><strong>Current Games.</strong> Show current games include pairing, score card and leaderboard</li>
		<li><strong>Previous Games</strong> Show Games already played</li>
		<li><strong>Performance.</strong> Tracks player performance on previous games.</li>
	</ul>
	<p>
    ...
    <p>
        If your name is <span class="auto-style1"><strong>John Doe</strong></span>&nbsp; then your username is<span class="auto-style1"><strong> jdoe</strong></span> and password is <span class="auto-style1"><strong>JDoe!</strong></span>
    </p>
    <p>
	...
	<h2>Safari Golf Members and Roles</h2>
	<p>
		Safari Golf Club Web site allows visitors to register as members and then log in.
	...
	<table cellpadding="0" cellspacing="0" border="1">
		...
		<tr>
			<td>Logged in</td>
			<td>May additionally browse the members directory, edit their own member directory information, view Current games, previous games, player performance
				and view private photos.</td>
		</tr>
		<tr>
			<td>Logged in as <strong>Administrators</strong></td>
			<td>May additionally edit all Current games, previous games, announcements, events, photos, and member directory entries.</td>
		</tr>
	</table>
	
	<p>
		Visitors can register by clicking the <strong>Register</strong> link. New members are activated automatically, but are not assigned to any role. Administrator can manage users (for example, assign them to a role). </p>


    
	<hr />

	<h2>Current Games, Previous Games and Player Performance</h2>
	<p>
		The Games Sections enables you to:</p>
	<ul>
		<li>Create Pairing of Golf Players for a selected Golf Course.</li>
		<li>Update or Generate Score cards from the pairings.</li>
		<li>View LeaderBoard for the current Game.</li>
	</ul>
	<h3>To create Golf Game Pairing</h3>
	<ol>
		<li>Log in to the site as an administrator (member in the role <strong>Administrators</strong>).</li>
		<li>In the navigation bar, click <strong>Current Game</strong>.</li>
		<li>Click <strong>on a Golf Course</strong>.</li>
		<li>Go to the "Current Pairing&quot;&nbsp; tab of the <strong>Current Game</strong> page.</li>
		<li>From the list of Golfers, Check the 4 or 5 players on the left, select the pairing Hole and the click the option &gt;&gt;&gt;Move Selection&gt;&gt;&gt; at the top</li>
		<li>Repeat till all the groups are created.</li>
        <li>When Done you can save the settings or save and create the Scorecards.</li>
	</ol>
	<h3>To enter scores on the Scorecard</h3>
	<ol>
		<li>Log in to the site as a golfer who is in a pairing </li>
		<li>Go to the "Current Score Card&quot;&nbsp; tab of the <strong>Current Game</strong> page. </li>
		<li>Player can update scores where he/she is a member of the pairing (<strong>Administrators</strong> can enter all scores).</li>
		<li>You can View other scorecards but can not update them if you do not belong to the scorecard.</li>
		<li>Once you enter the score, click SAVE to allow the scores to flow to the leaderboard.</li>
		<li>Once done member of the pairing can CLOSE the round. </li>
		<li>Once a game is closed, no changes can be made and only Administrators can reopen it for change</li>
	</ol>



	<h3>To View the LeaderBoard</h3>
	<ol>
		<li>Log in to the site as a golfer. </li>
		<li>Go to the "Current LeaderBoard&quot;&nbsp; tab of the <strong>Current Game</strong> page. </li>
		<li>This shows the ranking based on the Gross minus the lower of Ghin Handicap and Tournament Handicap</li>
        <li>Current max handicap rule of 28 for men and 36 for women applies.</li>
	</ol>



	<h3>To View the Previous Games</h3>
	<ol>
		<li>Log in to the site as a golfer. </li>
		<li>Click on the <strong>Previous Game</strong> page. </li>
		<li>Click on the Date-Course link to show those who played and their scores.</li>
	</ol>



	<h3>To View the Player Performance</h3>
	<ol>
		<li>Log in to the site as a golfer. </li>
		<li>Click on the <strong>Performance</strong> page. </li>
		<li>Click on the Player link to show the previous 20 games in a nice graph.</li>
	</ol>
	...
	<ul>
		<li>As a member, create albums of photos for use in our site.</li>
	...
	<h3>To create a Golf or Event location</h3>

	<ol>
		<li>Log in to the site as an administrator (member in the role <strong>Administrators</strong>).</li>
		<li>In the navigation bar, click <strong>Locations</strong>. </li>
		<li>Click <strong>Golf Courses List</strong>. </li>
