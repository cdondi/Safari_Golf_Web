<%@ Page Title="" Language="VB" MasterPageFile="~/Default.master"  AutoEventWireup="true"  CodeFile="ScorecardUpdate.aspx.vb"  Inherits="Events_Calendar" %>
...
onrowupdating="grdViewScorecard1UpdateScore"  onrowcancelingedit="grdViewScorecard1CancelEdit">
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Hole" HeaderStyle-HorizontalAlign="Left">            
            <ItemTemplate> 
                <asp:Label ID="playername1" runat="server" Text='<%# Eval("playername")%>' Width="36"></asp:Label> 
            </ItemTemplate> 
        </asp:TemplateField>  
        ...
        <asp:TemplateField HeaderText="1" HeaderStyle-HorizontalAlign="Left"> 
            ...
            <ItemTemplate> 
                <asp:Label ID="lbl1" runat="server" Text='<%# Eval("Score1")%>'></asp:Label> 
            </ItemTemplate> 
            <FooterTemplate> 
    ...
    <AlternatingRowStyle BackColor="White" />
      ...
      <br /><br /> 
     <table border="0" style="width: 820px"  cellpadding="0" cellspacing="0">  
        <tr> 
         <td>&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btnScoreCard" runat="server"   Text="Refresh"  height="33px" />&nbsp;&nbsp;<asp:Button ID="CreateScoreCard" runat="server" height="33px" Text="Create My ScoreCard" />
