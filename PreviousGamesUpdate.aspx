<%@ Page Title="" Language="VB" MasterPageFile="~/Default.master"  AutoEventWireup="true"  CodeFile="PreviousGamesUpdate.aspx.vb"  Inherits="Events_Calendar" %>
		   ...
		   <table>
			...
			<td>
				...
				<asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" >
					<ItemTemplate>
						<div> 
								<a href='<%# "PreviousGamesUpdate.aspx?Dateid=" + Convert.ToString(Eval("Dateid")) & "&locationid=" + Convert.ToString(Eval("locationid"))%>'>
