<%@ Page Title="" Language="VB" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Scorecard_LeaderBoard.aspx.vb" Inherits="Events_Calendar" %>
        ...
        -->
			...
			<div class="leftblock">
				...
				<asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource1" >
					<ItemTemplate>
						<div>  
							<h3>
								<a href='<%# "Scorecard_LeaderBoard.aspx?Dateid=" + Convert.ToString(Eval("Dateid")) & "&locationid=" + Convert.ToString(Eval("locationid"))%>'>
           ...
           <div class="rightblock">
				...
				<h2><asp:Label ID="DatePlayed1" runat="server"   Text="" /> <asp:Label ID="LocationPlayed" runat="server"   Text="" /></h2>
                            ...
                            <asp:GridView ID="GridViewClosed1"  runat="server" caption="Leader Board"
                                    ...
                                    <Columns>
                                            ...
                                            <asp:BoundField DataField="tournamenthandicap" HeaderText="T. HCP" 
                                            SortExpression="tournamenthandicap" />   
                                                                                
                                            <asp:BoundField DataField="ghinhandicap" HeaderText="G. HCP" 
                                            SortExpression="ghinhandicap" /> 
                                        
                                                                                                                       
                                            <asp:BoundField DataField="grandtotal" HeaderText="Gross" 
