...
Partial Class WebUserControl
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            sSql = "SELECT top 1  [LocationID],[PairingID] ,[Date]  FROM [tb_Scorecard] where [PairingID]  =" & ScorecardPairID & "  and [LocationId] =" & LocationID() & " and [Date] = '" & DateID() & "'"
    ...
    Private Sub grdViewScorecardpopupBindData()
        ...
        If drr.Read Then
            coursename0.Text = drr.Item("title").ToString()
        End If
        drr.Close()
