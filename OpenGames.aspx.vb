...
Partial Public Class Events_Calendar
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs)
        ...
        Dim TabParam As New ArrayList(New Object() {New ArrayList(New Object() {True, "Select Course", "OnTabClick(0)", True}), New ArrayList(New Object() {False, "Game Pairing", "OnTabClick(1)", True})})
    ...
    Private Sub bindalldata()
        ...
        While dr2.Read
            ...
            coursename1.Text = Trim(dr2.Item("title").ToString()) 
        End While
        dr2.Close()
    ...
    Private Sub gridMaleRatingBindData()
        ...
        If drr.Read Then
            ...
            rdoMaleTeeFront.Text = Trim(drr.Item("frontrating").ToString())
            rdoMaleTeeMiddle.Text = Trim(drr.Item("middlerating").ToString())
            rdoMaleTeeBack.Text = Trim(drr.Item("backrating").ToString())
    ...
    Private Sub gridFemaleRatingBindData()
        ...
        If drr.Read Then
            ...
            rdoFeMaleTeeFront.Text = Trim(drr.Item("frontrating").ToString())
            rdoFeMaleTeeMiddle.Text = Trim(drr.Item("middlerating").ToString())
            rdoFeMaleTeeBack.Text = Trim(drr.Item("backrating").ToString())
                ...
                If drr1.Read Then
                    ...
                    If Gender = "Male" Then
                        ...
                        If rdoMaleTeeFront.Checked Then
                            rating = rdoMaleTeeFront.Text
                            sSqlr = "SELECT frontslope from tb_maleCourseRating WHERE locationid = '" & LocationID & "'"
                            drr = GetDataReader(sSqlr)
                            If drr.Read Then
                        ...
                        If rdoMaleTeeMiddle.Checked Then
                            rating = rdoMaleTeeMiddle.Text
                            sSqlr = "SELECT middleslope from tb_maleCourseRating WHERE locationid = '" & LocationID & "'"
                            drr = GetDataReader(sSqlr)
                            If drr.Read Then
                        ...
                        If rdoMaleTeeBack.Checked Then
                            rating = rdoMaleTeeBack.Text
                            sSqlr = "SELECT backslope from tb_maleCourseRating WHERE locationid = '" & LocationID & "'"
                            drr = GetDataReader(sSqlr)
                            If drr.Read Then
                    ...
                    If Gender = "FeMale" Then
                        ...
                        If rdoFeMaleTeeFront.Checked Then
                            rating = rdoFeMaleTeeFront.Text
                            sSqlr = "SELECT frontslope from tb_FemaleCourseRating WHERE locationid = '" & LocationID & "'"
                            drr = GetDataReader(sSqlr)
                            If drr.Read Then
                                slope = Trim(drr.Item("frontslope").ToString())
                            End If
                        ...
                        If rdoFeMaleTeeMiddle.Checked Then
                            rating = rdoFeMaleTeeMiddle.Text
                            sSqlr = "SELECT middleslope from tb_FemaleCourseRating WHERE locationid = '" & LocationID & "'"
                            drr = GetDataReader(sSqlr)
                            If drr.Read Then
                                slope = Trim(drr.Item("middleslope").ToString())
                            End If
                        ...
                        If rdoFeMaleTeeBack.Checked Then
                            rating = rdoFeMaleTeeBack.Text
                            sSqlr = "SELECT backslope from tb_FemaleCourseRating WHERE locationid = '" & LocationID & "'"
                            drr = GetDataReader(sSqlr)
                            If drr.Read Then
                                slope = Trim(drr.Item("backslope").ToString())
                            End If
